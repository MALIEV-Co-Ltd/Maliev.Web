...
The customer-facing MALIEV website for manufacturing services, instant quotations, and the internal storefront replacing Shopify.
...
| `GET /web/v1/catalog/products/{handle}` | Product detail by Shopify-compatible handle. | Public |
| `GET /web/v1/shopify/import-preview` | Shopify migration readiness snapshot. | Public |
