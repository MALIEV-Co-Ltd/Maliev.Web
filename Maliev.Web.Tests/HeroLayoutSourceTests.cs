...
public sealed class HeroLayoutSourceTests
{
    ...
    public void HomeUsesFinishedManufacturingAndNewsSections()
    {
        ...
        Assert.Contains("Production workflow carousel", source);
        ...
        Assert.Contains("\"01\",\n            \"upload\",\n            Icons.Material.Filled.UploadFile", source);
        Assert.Contains("\"02\",\n            \"dfm\",\n            Icons.Material.Filled.FactCheck", source);
        Assert.Contains("\"03\",\n            \"price\",\n            Icons.Material.Filled.PriceChange", source);
        Assert.Contains("\"04\",\n            \"order\",\n            Icons.Material.Filled.Inventory2", source);
        Assert.True(
